...
function Boton(props) {
  ...
  const esOperador = (valor) => {
    ...
    /* isNaN dice que si valor no es número */
  };
  ...
  return (
    <div
      ...
      }`.trimEnd()} /* Decimos: si el resulado o valor retornado es true entonces se reemplaza por operador que va a ser la segunda clase que le asignamos al botón, de lo contratio se retorna null y no se hace ningún cambio en las clases.
